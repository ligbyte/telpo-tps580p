...
public class PieChartRenderer extends DataRenderer {
    ...
    protected void drawEntryLabel(Canvas c, String label, float x, float y) {
        ...
        for (int i = 0; i <lines.length ; i++) {
            if (i == 0){
                mEntryLabelsPaint.setColor(Color.parseColor("#000000"));
            }else {
                mEntryLabelsPaint.setColor(Color.parseColor("#666666"));
            }
            c.drawText(lines[i], x, y, mEntryLabelsPaint);
            y += mEntryLabelsPaint.descent() - mEntryLabelsPaint.ascent();
        }
//        for (String line: label.split("\n")) {
//            c.drawText(line, x, y, mEntryLabelsPaint);
//            y += mEntryLabelsPaint.descent() - mEntryLabelsPaint.ascent();
//        }
